...
export class Request {
	...
	getResponse(middlewareManager, httpRequest) {
		const handler = this._getHandler(middlewareManager, httpRequest);
	...
	_getHandler(middlewareManager, httpRequest) {
		return new RequestHandler(this, middlewareManager, httpRequest);
	}
}
