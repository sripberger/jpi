...
export class Request {
	...
	// TODO: Create a class to reduce this argument count.
	getResponse(middlewareManager, methodRegistry, httpRequest) {
	...
	_getHandler(middlewareManager, methodRegistry, httpRequest) {
